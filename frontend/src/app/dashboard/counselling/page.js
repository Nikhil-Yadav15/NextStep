      ...
      <div className="container mx-auto px-4 py-8 max-w-7xl">
        ...
        <div className="mb-8">
          <div className="flex items-center gap-3 mb-2">
            <div className="p-2.5 rounded-xl bg-gradient-to-br from-blue-600 to-cyan-600">
          ...
          <button
            ...
            className={`flex items-center gap-2 px-5 py-2.5 rounded-xl text-sm font-medium transition-all border ${
              activeTab === "mentors"
                ...
                : "bg-slate-900/40 text-slate-400 border-slate-800/50 hover:text-white"
            }`}
          >
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <div className="relative flex-1">
                ...
                <input
                  ...
                  className="w-full bg-slate-900/60 border border-slate-800/50 rounded-xl pl-10 pr-4 py-2.5 text-sm text-white placeholder-slate-500 focus:outline-none focus:border-blue-500/50 transition-colors"
                />
              </div>
            </div>
